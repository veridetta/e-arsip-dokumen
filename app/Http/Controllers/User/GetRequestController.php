...
class GetRequestController extends Controller
{
    public function index()
    {
        ...
        return view('user.get_requests.index', compact('data'));
    }

    public function create()
    {
        $users = User::where('id', '!=', auth()->user()->id)->get();
        return view('user.get_requests.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($simpan){
            return redirect()->route('user.get-requests.index')->with('message', [
                'success' => true,
                'message' => 'Request sent successfully'
            ]);
        }else{
            return redirect()->route('user.get-requests.create')->with('message', [
                'success' => false,
    ...
    public function show($id)
    {
        ...
        return view('user.get_requests.show', compact('data', 'requests'));
    }

    public function edit($id)
    {
        $data = Document::findOrFail($id);
        return view('user.get_requests.edit', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($simpan){
            ...
            return redirect()->route('user.get-requests.edit', $id)->with('message', [
                'success' => false,
    ...
    public function preview($id)
    {
        ...
        return view('user.get_requests.preview', compact('data', 'auth'));
    }
}
