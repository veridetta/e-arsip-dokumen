...
class PrivateDocumentController extends Controller
{
    public function index()
    {
        ...
        return view('user.private_document.index', compact('data'));
    }

    public function create()
    {
        return view('user.private_document.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($simpan){
            return redirect()->route('user.private-documents.index')->with('message', [
                'success' => true,
                'message' => 'Document created successfully'
            ]);
        }else{
            return redirect()->route('user.private-documents.create')->with('message', [
                'success' => false,
    ...
    public function show($id)
    {
        ...
        return view('user.private_document.show', compact('data', 'requests'));
    }

    public function edit($id)
    {
        $data = Document::findOrFail($id);
        return view('user.private_document.edit', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($simpan){
            ...
            return redirect()->route('user.private-documents.edit', $id)->with('message', [
                'success' => false,
    ...
    public function preview($id)
    {
        ...
        return view('user.private_document.preview', compact('data', 'auth'));
    }
}
