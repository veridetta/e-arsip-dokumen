...
@section('title', 'Lihat Dokumen Client')
@section('content')
    <main class="content">
        <div class="container p-0">
            <h1 class="mb-3 fw-bold my-text-color">Lihat Dokumen Client</h1>
            ...
            <div class="card">
                <div class="card-body">
                    <?php
                        ...
                        ?>
                        @if ($ext == 'pdf')
                            <embed src="{{ url('storage/clients/' . $data->file) }}#toolbar=0" type="application/pdf"
                                width="100%" height="600px" />
                        @else
                        {{-- <div id="docx-preview" data-file="{{ '../../../storage/private-documents/' . $data->file }}"></div> --}}

                        <?php
                        $url = url('storage/clients/' . $data->file);
