...
@section('content')
    <main class="content">
        <div class="container p-0">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.general-documents.update', [$data->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="general_category_id" id="general_category_id"
                                class="form-select @error('general_category_id') is-invalid @enderror">
                                <option value="">Pilih Jenis Dokumen</option>
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}"
                                        {{ $category->id == $data->general_category_id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <labe class="d-block">File saat ini: <a href="{{ url('storage/general-documents/' . $data->file) }}"
