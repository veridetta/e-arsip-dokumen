...
@section('content')
    <main class="content">
        <div class="container p-0">
            <h1 class="mb-3 fw-bold my-text-color">Minta Izin Akses Dokumen Khusus</h1>
            @include('components.flash-message')
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-4 justify-content-end">
                        <a href="{{ route('user.get-requests.create') }}" class="btn my-bg text-white p-2 px-4"><i
                            ...
                            @foreach ($data as $data)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('user.get-requests.preview', [$data->id]) }}"
