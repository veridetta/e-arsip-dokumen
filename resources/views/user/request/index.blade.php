...
@section('content')
    <main class="content">
        <div class="container p-0">
            <h1 class="mb-3 fw-bold my-text-color">Kelola Permintaan Dokumen</h1>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($data->status == 'pending')
                                            ...
                                            <form action="{{ route('user.requests.reject', $data->id) }}" method="post"
                                ...
                                <div class="modal fade text-start" id="replyModal{{ $data->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('user.requests.reply', $data->id) }}" method="post">
                                                @csrf
